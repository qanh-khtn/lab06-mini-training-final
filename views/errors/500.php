...
<div class="error-page">
    <div>
        <div class="error-code">
            <span class="material-symbols-outlined" style="font-size: 64px; display: block; margin-bottom: 12px; color: var(--danger);">error</span>
            500
        </div>
        <div>
            ...
            <a class="btn btn-primary" href="/">
                <span class="material-symbols-outlined" style="font-size:16px;">dashboard</span> Về Dashboard
            </a>
        </div>
    </div>
</div>
